...
const ProjectDetails = () => {
  ...
  return (
    <div className="content project-details mt-5">
      <div className="d-flex justify-content-between">
        ...
        <div className="">
          <a
            ...
            target="_blank"
            className="btn btn-primary-none text-light border-light me-4 rounded-0"
          >
            View Live Demo
          </a>
          <a
            ...
            target="_blank"
            className="btn btn-primary-none text-light border-light rounded-0"
          >
            View Code
          </a>
        </div>
      ...
      <div className="site-landing mt-5">
        <div className="row">
          <div className="col">
            <img src={siteLanding} style={{ width: "35rem" }}></img>
          </div>
          <div className="col">
            <h5>Landing Page</h5>
            <p>
              ...
              users. Placing a friendly image of the client on one side and the
              lead text with a clear call-to-action on the other side helps
              guide users' attention and encourages interaction.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="row">
          <div className="col-md-6">
            ...
            <p>
              ...
              upon signing into the system. Admins have the privilege to perform
              CRUD (Create, Read, Update, Delete) operations on posts, including
              the ability to save drafts for future publication. This section
              provides a comprehensive interface for managing blog content
              efficiently and effectively, empowering administrators to maintain
              and curate the blog with ease.
            </p>
          </div>
          <div className="col-md-6">
            <img src={dashboard} style={{ width: "35rem" }}></img>
          </div>
        </div>
      </div>
      ...
      <div className="site-landing mt-5 pt-5">
        <div className="row">
          <div className="col">
            <img src={editorActions} style={{ width: "35rem" }}></img>
          </div>
          <div className="col">
            <h5>Post Managemnt</h5>
            <p>
              The post editor is designed with CKEditor 5, providing users with
              a versatile text editing experience. It seamlessly integrates
              image insertion capabilities, allowing users to enhance their
              posts with visuals. Additionally, users can include a cover image
              to complement and personalize each post. Posts are saved with
              attribution to authors, ensuring proper acknowledgment, and the
              date of publication is recorded for chronological organization and
              reference.{" "}
            </p>
          </div>
        </div>
      ...
      <div className="site-landing mt-5 pt-5">
        <div className="row">
          ...
          <div className="col">
            <img src={userHandling} style={{ width: "35rem" }}></img>
          </div>
        </div>
      </div>
    </div>
